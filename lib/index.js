...
var _a = process_1.default.argv, execPath = _a[0], javascriptFilePath = _a[1], inputPath = _a[2], typeOfGenerator = _a[3], rest = _a.slice(4);
fs_1.default.readFile(inputPath, "utf8", function (err, data) {
    ...
    try {
        ...
        var codeGeneratingUnit = new generators_1.default(typeOfGenerator, {
            moduleName: "MyModule"
        });
