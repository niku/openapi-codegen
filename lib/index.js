...
fs_1.default.readFile(inputPath, "utf8", function (err, data) {
    ...
    try {
        ...
        var codeGeneratingUnit = new code_generating_unit_1.default(new code_generating_unit_type_1.default(codeGeneratingUnitType));
        var doc = new generator_1.default().generate({
            moduleName: "MyModule",
            openAPI: obj
        });
        // tslint:disable-next-line:no-console
