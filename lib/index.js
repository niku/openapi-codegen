...
const [execPath, javascriptFilePath, inputPath, outputPath, moduleName, ...rest] = process_1.default.argv;
function buildConfigFromArguments(...configs) {
    const result = {};
    try {
        configs.forEach(c => {
...
const config = buildConfigFromArguments(...rest);
