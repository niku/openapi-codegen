...
var _a = process_1.default.argv, execPath = _a[0], javascriptFilePath = _a[1], inputPath = _a[2], type = _a[3], cs = _a.slice(4);
var config = {};
...
fs_1.default.readFile(inputPath, "utf8", function (err, data) {
    ...
    try {
        ...
        var generators = new generators_1.default(type, config);
