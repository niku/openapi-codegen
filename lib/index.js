...
fs_1.default.readFile(inputPath, "utf8", function (err, data) {
    ...
    try {
        ...
        var codeGeneratingUnit = new generators_1.default(new code_generating_unit_type_1.default(codeGeneratingUnitType), new code_generating_config_1.default({ moduleName: "MyModule" }));
